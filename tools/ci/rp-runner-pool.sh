...
# 925 = Linux, 911 = Windows, both 16 GB / 6 vCPU — resized 2026-08 after the
...
# Current templates: 925 (Linux), 911 (Windows).
#
...
#
# 925 gives every clone a unique hostname and closes an ownership hole the
# SDK installers had left. It descends from 920 through four intermediate
# captures (921, 922, 923, 924) that were superseded before deployment and have
...
# address space. 925 carries an `rp-hostname.service` running
...
# local escalation to root inside the clone. All are root:root 755 in 925.
#
...
# /usr/local/sbin and /usr/local/bin are therefore root:root 755 in 925. The
...
SLOTS=(
  "runner-linux1|925|9100|linux|[\"self-hosted\",\"Linux\",\"X64\",\"proxmox-ephemeral\"]"
  "runner-linux2|925|9101|linux|[\"self-hosted\",\"Linux\",\"X64\",\"proxmox-ephemeral\"]"
  "runner-linux3|925|9102|linux|[\"self-hosted\",\"Linux\",\"X64\",\"proxmox-ephemeral\"]"
