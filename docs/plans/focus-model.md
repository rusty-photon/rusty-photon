...
|-------|-------------|--------|------------|
| S1 | `rp`: `auto_focus` retries with the same parameters, shifts on `monotonic_curve`, reports the wing slope, carries `curve_points` in fit-failure errors | Not started | [#1202](https://github.com/rusty-photon/rusty-photon/issues/1202) |
